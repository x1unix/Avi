 ...
 *
 */
public class AviWebChromeClient extends WebChromeClient implements MediaPlayer.OnPreparedListener, MediaPlayer.OnCompletionListener, MediaPlayer.OnErrorListener
{
     ...
     */
    @SuppressWarnings("unused")
    public AviWebChromeClient(View activityNonVideoView, ViewGroup activityVideoView)
    {
     ...
     */
    @SuppressWarnings("unused")
    public AviWebChromeClient(View activityNonVideoView, ViewGroup activityVideoView, View loadingView)
    {
        this.activityNonVideoView = activityNonVideoView;
        this.activityVideoView = activityVideoView;
     ...
     */
    @SuppressWarnings("unused")
    public AviWebChromeClient(View activityNonVideoView, ViewGroup activityVideoView, View loadingView, AviWebView webView)
    {
        this.activityNonVideoView = activityNonVideoView;
        this.activityVideoView = activityVideoView;
        this.loadingView = loadingView;
